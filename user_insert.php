<html>
    ...
    <body>
        ...
        <div class="container marketing">
            <h2 class="featurette-heading text-center text-uppercase">Add User</h2>
            <hr>
            <br><br>
        <?php
            if (!isset($_POST['send'])) {
        ?>
            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div class="form-group row d-flex justify-content-center">
                    <label for="example-text-input" class="col-2 col-form-label text-uppercase">Username :</label>
                    <div class="col-3">
                        <input class="form-control" type="text" name="username" id="example-text-input">
                    </div>
                </div>
                <div class="form-group row d-flex justify-content-center">
                    <label for="example-text-input" class="col-2 col-form-label text-uppercase">Password :</label>
                    <div class="col-3">
                        <input class="form-control" type="text" name="password" id="example-text-input">
                    </div>
                </div>
                <div class="form-group row d-flex justify-content-center">
                    <label for="example-text-input" class="col-2 col-form-label text-uppercase">E-mail :</label>
                    <div class="col-3">
        ...
        <?php 
                ...
                $sql = "Insert into usertb values('$id', '$username', '$password', '$email');";
                $result = mysqli_query($link, $sql);
                if ($result)
            {
            echo "<br><div class='col-md10'><h2 class='featurette text-center text-uppercase'>Update user information successfully</h2></div>";
            mysqli_close($link);
            }
            else
            {
            echo "<br><div class='col-md10'><h2 class='featurette text-center text-uppercase'>User information cannot be update</h2></div>";
            }
            }
        ?>
